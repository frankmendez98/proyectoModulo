		...
		<div class="col-lg-12">
			<div class="ibox ">
				<div class="ibox-title">
					<h3 class="text-navy"><b><i class="fa fa-1x fa-file-pdf-o"></i> Reporte de Ventas</b></h3>
				</div>
				<div class="ibox-content">
					<form method="POST" action="<?=base_url("admin/reporte_ventas/generar");?>" target="_blank">
						<div class="row">
							<div class="col-md-6">
