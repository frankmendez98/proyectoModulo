		...
		<div class="col-lg-12">
			<div class="ibox" id="main_view">
				<div class="ibox-title">
					<h3 class="text-navy"><b><i class="fa fa-plus-circle"></i> Agregar SubCategoria</b></h3>
				</div>
						...
						<div class="row">
							<div class="col-lg-6">
								<div class="form-group single-line">
									<input type="hidden" name="id_categoria" id="id_categoria" value="<?=$id_cat?>">
						...
						<div class="row">
							<div class="col-lg-12">
								<div class="mt-3">
									...
									<p class="text-muted text-center mt-2 mb-0">Agrega foto</p>
								</div>
							</div>
						</div>
						<div class="row">
