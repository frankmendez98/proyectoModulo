...
<head>
	...
	<title>Mega Libreria - Confirmaci&oacute;n de Compra!</title>
<style type="text/css">
	table.tableHead {
...
<body class="estilo" >
					...
					<div>			
                                ...
                                <table class="tableBill">
                                   ...
                                   <tr rowspan=2>
										 <th colspan=2 ><strong> Mega Libreria <br> ORDEN DE COMPRA N° <?= $ord['numero_orden']; ?></strong></th>
                                        ...
                                        <tr>
                                            ...
                                            <th>Total $ <?php echo number_format(+$ord['total']+$ord['envio'],2,".",",") ?></th>
                                             <th>Fecha: <?php echo $ord['fecha']?></th>
                                             <th>Hora: <?php echo $ord['hora'] ?></th>
                                        </tr>
                            ...
                            <!--detalle-->
                               ...
                               <table class="tableBill">
								 ...
								 foreach($detOrden as $row):
									 ...
									 ?>
									 <tr>
									<td class="text-left"><?php echo $row['id_producto']." - ".$row['descripcion']?></td>
								...
								<tfoot>
                                        <tr>
                                            ...
                                            <td class="text-right" colspan=3>$ <?php echo number_format($ord['total'],2,".",",") ?></td>
                                        </tr>
                                         <tr>
                                            <td class="text-left" colspan=1><span class="text-gray-dark">Envio</span></td>
                                            <td class="text-right" colspan=3>$ <?php echo number_format($ord['envio'],2,".",",") ?></td>
                                        </tr>
                                         <tr>
                                            <td class="text-left" colspan=1><span class="text-gray-dark">Total final</span></td>
                                            <td class="text-right" colspan=3>$ <?php echo number_format($ord['total']+$ord['envio'],2,".",",") ?></td>
                                        </tr>
