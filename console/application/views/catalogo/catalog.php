										...
										<ul class='listCat'>
											<?php if(!empty($categorias)){
												foreach($categorias as $categoria){
													...
													<?php if ($categoria["issub"]): ?>
														<li class='liCat'><input id="id_cat" class='byCat2 subt' type='hidden' value='<?php echo $id_cat?>' /> <a class='ref' href="javascript:void(0);"><?php echo $cat?></a></li>
													<?php else: ?>
