                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 col-12 padding-30px-left md-padding-15px-lr order-1 order-lg-2 sm-margin-35px-bottom">
                        ...
                        <div class="row no-gutters align-items-center bg-light-gray rounded padding-15px-all margin-35px-bottom">
                            ...
                            <div class="col-12 col-md xs-margin-5px-tb xs-text-center">Mostrando  <?php echo $numrows?> registros</div>
                            ...
                            <div class="col-12 col-md-auto">
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-auto xs-margin-5px-tb">
                                        <label class="no-margin">Show:</label>
                                        <select class="w-auto display-inline-block form-control bg-white medium">
                                ...
                                <div class="product-grid">
                                    <div class="product-img">
                                        <a href="shop-product-detail.html">
                                            ...
                                            <!--img class="img-sale" src="<!--?php echo $rutaImgProd?>" alt="..."></a-->
                                    </div>
...
<ul class="pagination pull-right">
    <?php echo $this->pagination->create_links(); ?>
                        ...
                        <!--div class="pagination text-small text-uppercase text-extra-dark-gray margin-20px-top sm-margin-15px-top">
                            <ul>
                                <li><a href="shop-product-grid.html#!"><i class="fas fa-long-arrow-alt-left margin-5px-right xs-display-none"></i> Prev</a></li>
                                <li class="active"><a href="shop-product-grid.html#!">1</a></li>
                                <li><a href="shop-product-grid.html#!">2</a></li>
                                <li><a href="shop-product-grid.html#!">3</a></li>
                                <li><a href="shop-product-grid.html#!">Next <i class="fas fa-long-arrow-alt-right margin-5px-left xs-display-none"></i></a></li>
                            </ul>
                        </div-->
                        <!-- end pagination -->
