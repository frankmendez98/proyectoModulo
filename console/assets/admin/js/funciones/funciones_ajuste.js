  ...
  var dataString = 'process=consultar_stock&id_producto=' + id_prod;
    ...
    $.ajax({
      ...
      success: function(data) {
        ...
        tr_add += "<td class='col-md-1'>"+data.talla+"</td>";
        tr_add += "<td class='col-md-2'><input type='text'  class='form-control existencia' id='existencia' name='existencia' value='" + stock + "' style='width:80px;' readOnly></td>";
        tr_add += "<td class='col-md-1'><input type='text'  class='form-control precio_compra' id='precio_compra' name='precio_compra' value='" + precios + "' style='width:80px;'></td>";
        tr_add += "<td class='col-md-2'><input type='text'  class='form-control decimal' id='cant' name='cant' value='' style='width:60px;'></td>";
